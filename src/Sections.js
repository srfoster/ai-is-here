...
let EndOfIntroduction = <GatedSection>
  <ReactMarkdown>{`#### 4.

I'll close the introduction by sketching out what's to come.

In **Part One: The Currency of Words**, we'll examine how the fundamental strength of AI-writing is also its fundamental weakness: namely, that it can mint lot of words very quickly.  This is a double-edged sword because words **sometimes** have value, but they **always** have cost.  In fact, there are three kinds of costs associated with words:

1. **Writing Cost**. There's a monetary cost associated with each token generated by models like GPT.  (You've generated <<>> tokens so far, which has cost me <<>>.)
2. **Reading Cost**. There's the cognitive cost associated with each word that a human brain must read and think about.  This is time not spent doing other things, so there's opportunity cost.  
3. **Context Cost**.  Models like GPT have a "context window" of 8000 to 32000 words -- meaning that they can only "think about" this many words at a time.  As a document grows beyond this limit (which can happen in a matter of seconds), the model begins to forget what it previously wrote.  There are various costs associated with missing context. 

In addition to an investigation of costs, we'll also investigate how words generate value.  And of course, there's the big question for the future of knowledge work: When does the value justify the cost?  This is a question that almost every sector of the knowledge economy (including education) will have to continually grapple with as AI-writing becomes more and more ubiquitous. 

In **Part Two: The Market of Expertise**, we'll examine how the value of human expertise is changing in the age of AI.  Some forms of human expertise will inevitably decrease in value, in much the same way that spelling skills became less valuable with the arrival of ubiquitous spellchecking.  Other forms of human expertise will increase in value -- in particular the kinds of expertise that help offset the aforementioned costs of AI-writing.  We'll also take a deep look at what these economic shifts mean for educational institutions that seek to train individuals to thrive economically.  With the knowledge economy in flux, education finds itself trying to aim at a moving target.

In **Part Three: The Economy of Education**, we'll look at how AI-writing can be used to automate the production of textbooks, assessments, and tutoring sessions -- three paradigm shifts in the tools and techniques for expertise acquisition.  The age of one-size-fits all education is largely over, with AI-writing poised to personalize everything from K-12 to higher ed, disrupting not only how educators and students have operated for centuries, but also the organizational structure of educational institutions as we know them.  Education is, after all, a unique form of knowledge work, and knowledge work as a whole is changing, presenting education with a dual challenge: of 1) aiming at a moving economic target while 2) being restructured from within.
